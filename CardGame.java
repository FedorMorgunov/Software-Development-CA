...
public class CardGame {
    public static void main(String[] args) {
        ...
        while (!validInput) {
            System.out.print("Enter the number of players (e.g. 8): ");
            try {
        ...
        while (!validPackFile) {
            System.out.print("Please enter the location of the pack file (e.g. /home/eight_players.txt): ");
...
// Fill the decks from the remaining cards in the pack in a round-robin fashion
        ...
        for (Player player : players) {
            ...
            try {
                ...
                System.out.println("error writing deck output files");
            }
        }
    }
}