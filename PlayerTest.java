...
public class PlayerTest {
    ...
    @Test
    public void testPlayerInitialization() {//checks to see that a player object can be created correctly
        int playerIndex = 1;
    ...
    @Test
    public void testAddCardToHand() { //tests a card can be added to the players hand
    ...
    @Test
    public void testSetLeftAndRightDeck() {//ensures that the left and right decks can be set correctly
    ...
    @Test
    public void testTakeFromDeckAndRemoveFromHand() throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {//tests that the takefromdeck and removefromhand methods function correctly
        Player player = new Player(1);
